...
- 1. Profile management (CRUD + onboarding state)
- 1. TDEE engine (Mifflin-St Jeor BMR → PAL → phase adjustment)
- 1. Macro calculator (protein-first cascade by phase)
- 1. Deload checker (scheduled + fatigue-triggered)
- 1. Progressive overload detector (Epley 1RM + rep-ceiling logic)
- 1. Global event bus for cross-module communication
- 
- Usage:
